...
namespace FinalGlicNow
{
    ...
    */
        ...
        //ARRUMAR ESSE PROBLEMINHA AQUI:
            //CRIAR UMA "FUNÇÃO" QUE PUXE A FOTO DE PERFIL DA PESSOA PARA O picPERFIL
            private void picEditar_Click(object sender, EventArgs e)
        {
            /* Fazer com que o usuário possa trocar a foto de fundo
             * Atualizar o banco de dados com esse foto
             */ 
        }
        //========================
        ...
        //ARRUMAR ESSE PROBLEMINHA AQUI: (Fazer com que a senha fique com a bolinha)
